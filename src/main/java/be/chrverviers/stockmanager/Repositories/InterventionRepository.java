...
public class InterventionRepository implements IRepository<Intervention> {
	...
	RowMapper<Intervention> rowMapper = (rs, rowNum) -> {
		...
		Item item = new Item();
		item.setId(rs.getInt(19));
		item.setReference(rs.getString(20));
	...
	RowMapper<Intervention> withNotifierRowMapper = (rs, rowNum) -> {
		...
		notifier.setId(rs.getInt(19));
		notifier.setUsername(rs.getString(20));
		notifier.setFirstname(rs.getString(21));
		notifier.setLastname(rs.getString(22));
		notifier.setIsActive(rs.getBoolean(23));
		intervention.setNotifier(notifier);
		Item item = new Item();
		item.setId(rs.getInt(24));
		item.setReference(rs.getString(25));
		return intervention;
	};
	...
	RowMapper<Intervention> withNotifierAndItemRowMapper = (rs, rowNum) -> {
		...
		item.setId(rs.getInt(24));
		item.setReference(rs.getString(25));
		item.setSerial_number(rs.getString(26));
		intervention.setItem(item);
